var /*makePortfolioController = require('./controllers/portfolio-controller')
...
function makeRoutes (app, serviceLocator) {
  ...
  app.get('/', function (req, res/*, next*/) {
    ...
    var images = _.times(12, function() {
      var height = _.random(200, 500)
      return 'http://dummyimage.com/336x' + height + '/000/fff&text=awh+ding'
    });

    res.render('front-end/index', { images: images } )
  })
